...
LAB_WIDTH = 14
FUDGE = 3
imagen1=PhotoImage(file="photo1.pgm")
imagen2=PhotoImage(file="photo2.pgm")
imagen3=PhotoImage(file="photo3.pgm")
imagen4=PhotoImage(file="photo4.pgm")
imagen5=PhotoImage(file="photo5.pgm")
