...
L_sel1.grid(column = 0, row = 0, pady = 2, sticky=W)
in1 = StringVar()
camp1 = Entry(frame1,textvariable=in1).place(x=50,y=0)


L_sel2 = Label(frame1, text="Pass:")
L_sel2.grid(column = 0, row = 1, pady = 2, sticky=W)
in2 = StringVar()
camp2 = Entry(frame1,textvariable=in2,show="*").place(x=50,y=25)
